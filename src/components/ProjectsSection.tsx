          ...
          {projects.map((project, index) => (
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard className="group overflow-hidden dark:border-purple-500/10 h-full flex flex-col">
                ...
                <CardFooter className="flex flex-col md:flex-row justify-between md:justify-between items-center border-t border-border/30 bg-gradient-to-r from-purple-500/5 to-pink-500/5">
                  <motion.div
                    className="flex items-center text-sm whitespace-pre-line leading-tight hover:text-purple-500 transition-colors group/link pt-8 max-w-[55%] mr-6"
